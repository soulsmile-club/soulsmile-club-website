            ...
            <div id="picAndDetailsContainer">
                ...
                <div id="detailsContainer">
                    ...
                    <div id="profileStats">
                        ...
                        <div className="stat">
                            <div className="statNum" style={{color: "#70A36A"}}>84</div>
                            <div className="statDesc">Soulsmiles Given</div>
                        </div>
                        <div className="stat">
                            <div className="statNum">3.6</div>
                            <div className="statDesc">Soulsmiles in Wallet</div>
                        </div>
                    </div>
                    <div id="giveButton">
                        <Button id="giveSoulsmilesButton" bsPrefix="donateButton">Give Soulsmiles <IoMdSend id="giveIcon" size={18} /></Button>
                    </div>
                </div>
            </div>
        </div>
