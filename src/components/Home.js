...
function Home(props) {
  ...
  const soulsmileHeader = (<header className="App-header-home">
  ...
  return (
    ...
    <div class="home-body">
      ...
      {/* TFAC Ternary Operators */}
      {collab ? <div><AffiliateBanner collab={collab}/></div> : <></>}
      {collab ? carousel : soulsmileHeader}
      {collab ? soulsmileHeader : carousel}
