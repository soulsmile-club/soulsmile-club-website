...
import Jenny_Jiang from '../images/team/Jenny_Jiang.jpg';
  ...
  return (
    ...
    <div className="flex-container-team">
      ...
      <div>
        ...
        <h5 id="role">CTO</h5>
        <h4 id="major">Computer Science, Psychology</h4>
      ...
      <div>
        <img alt="" id="team" src={Jenny_Jiang}></img>
        <h4 id="name">Jenny Jiang</h4>
        <h5 id="role">CPO</h5>
        <h4 id="major">Design Engineering, Statistics and Media</h4>
        <p id="description">Hi I’m Jenny. As a master student in Design Engineering, I believe Soulsmile can invite more people to effortlessly participate and donate to social causes they care about.</p>
        <p id="description">If I could give 30 soulsmiles every month, I would give them
        to <a href="https://girlswhocode.com/" target="_blank" rel="noopener noreferrer">Girls Who Code</a> and <a href="http://tfchina.org/" target="_blank" rel="noopener noreferrer">Teach for China</a>.</p>
      </div>
      <div>
